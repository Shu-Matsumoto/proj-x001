...
interface CardDataProps {
  ...
  onChangeValue: (id: number, data: UserTypes.LectureSchedule) => void
  // 削除ボタンを押した時のイベントハンドラ
...
export const CardData = (props: CardDataProps) => {
	// #region Fields
	// 編集した生徒情報を格納するデータ
	const [cardData, setCardData] = useState<UserTypes.LectureSchedule>(UserTypes.GetObj_LectureSchedule())
	// #endregion Fields
	// #region Functions
	// カード内データ値の変更イベントハンドラ
