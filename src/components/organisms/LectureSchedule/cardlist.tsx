...
import { CardData } from '../LectureSchedule/card';
import * as UserTypes from '../../../types/userTypes'

export const LectureScheduleCardList = () => {
	// #region Fields
	// カード追加の都度インクリメントするカウンタ
	const [cardDataCounter, setCardDataCounter] = useState(0)
	const [cardDataList, setCardDataList] = useState<{ id: number, data: UserTypes.LectureSchedule }[]>(new Array())
	// #endregion Fields
	// カード追加
	function addCard(): void {
		cardDataList.push({ id: cardDataCounter, data: UserTypes.GetObj_LectureSchedule() })
	...
	// リスト情報更新
	function changeListData(id: number, setData: UserTypes.LectureSchedule): void {
