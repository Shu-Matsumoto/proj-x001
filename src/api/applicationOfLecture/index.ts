...
export const AddApplicationOfLecture = async (
  ...
  data: UserTypes.ApplicationOfLecture
}> => {
  const address = `${context.apiRootUrl.replace(
    /\/$/g,
    '',
  )}/application_of_lectures`
  const apiResult: {
    code: number
    message: string
    data: UserTypes.ApplicationOfLecture
...
export const GetApplicationOfLecture = async (
  ...
  result: UserTypes.AppResult
  data: UserTypes.ApplicationOfLectureWithOptionData
}> => {
  const address = `${context.apiRootUrl.replace(
    /\/$/g,
    '',
  )}/application_of_lectures/${application_of_lecture_id}`
  const apiResult: {
    code: number
    message: string
    data: UserTypes.ApplicationOfLectureWithOptionData
...
export const UpdateApplicationOfLecture = async (
  ...
  const address = `${context.apiRootUrl.replace(
    /\/$/g,
    '',
  )}/application_of_lectures/${postData.id}`
  const apiResult: {
    code: number
    message: string
    data: UserTypes.ApplicationOfLecture
...
export const GetMyApplicationOfLectures = async (
  ...
  const address = `${context.apiRootUrl.replace(
    /\/$/g,
    '',
  )}/${user_id}/application_of_lectures`
  const apiResult: {
    code: number
    message: string
    data: UserTypes.ApplicationOfLecture[]
